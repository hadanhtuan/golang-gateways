...
type PropertyServiceClient interface {
	...
	GetFavorite(ctx context.Context, in *MessageQueryFavorite, opts ...grpc.CallOption) (*sdk.BaseResponse, error)
}
...
func (c *propertyServiceClient) GetReview(ctx context.Context, in *MessageQueryReview, opts ...grpc.CallOption) (*sdk.BaseResponse, error) {
	out := new(sdk.BaseResponse)
...
func (c *propertyServiceClient) GetAmenity(ctx context.Context, in *MessageQueryAmenity, opts ...grpc.CallOption) (*sdk.BaseResponse, error) {
	out := new(sdk.BaseResponse)
...
func (c *propertyServiceClient) GetFavorite(ctx context.Context, in *MessageQueryFavorite, opts ...grpc.CallOption) (*sdk.BaseResponse, error) {
	out := new(sdk.BaseResponse)
...
type PropertyServiceServer interface {
	...
	GetFavorite(context.Context, *MessageQueryFavorite) (*sdk.BaseResponse, error)
...
func (UnimplementedPropertyServiceServer) GetReview(context.Context, *MessageQueryReview) (*sdk.BaseResponse, error) {
...
func (UnimplementedPropertyServiceServer) GetAmenity(context.Context, *MessageQueryAmenity) (*sdk.BaseResponse, error) {
...
func (UnimplementedPropertyServiceServer) GetFavorite(context.Context, *MessageQueryFavorite) (*sdk.BaseResponse, error) {
...
func _PropertyService_GetReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyServiceServer).GetReview(ctx, req.(*MessageQueryReview))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PropertyService_GetAmenity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyServiceServer).GetAmenity(ctx, req.(*MessageQueryAmenity))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PropertyService_GetFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyServiceServer).GetFavorite(ctx, req.(*MessageQueryFavorite))
	}
	return interceptor(ctx, in, info, handler)
}
