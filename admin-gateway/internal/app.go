...
import (
	"fmt"
	"net/http"
	apiPayment "admin-gateway/api/payment"
	apiProperty "admin-gateway/api/property"
	apiSearch "admin-gateway/api/search"
	apiUser "admin-gateway/api/user"

	protoPayment "admin-gateway/proto/payment"
	protoProperty "admin-gateway/proto/property"
	protoSearch "admin-gateway/proto/search"
	protoUser "admin-gateway/proto/user"
